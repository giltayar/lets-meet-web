  ...
  render() {
    ...
    return (
      <div className="Network">
        <h1>{this.state.my_name} send to {this.state.recipient_name}</h1>
        <div id="users_container">
          {element_users}
        </div>
        <div id="conteinerNetwork">
          <input id="message" type="text" placeholder="Welcome to privat chat, write your message..." onChange={(event) => { this.message = event.target.value }} />
